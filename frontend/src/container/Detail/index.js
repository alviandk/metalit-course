...
import instructor from "../../assets/images/instructor/01.jpg";
import avatar1 from "../../assets/images/avatar/09.jpg"
import avatar2 from "../../assets/images/avatar/02.jpg"
import avatar3 from "../../assets/images/avatar/09.jpg"
import avatar4 from "../../assets/images/courses/4by3/01.jpg"
import avatar5 from "../../assets/images/courses/4by3/21.jpg"
import avatar6 from "../../assets/images/courses/4by3/18.jpg"
				...
				<div class="container">
					<div class="row py-5">
						<div class="col-lg-8">
							...
							<p>Satisfied conveying a dependent contented he gentleman agreeable do be.
							...
							<ul class="list-inline mb-0">
								<li class="list-inline-item h6 me-3 mb-1 mb-sm-0">
									<i class="fas fa-star text-warning me-2"></i>4.5/5.0
								</li>
								<li class="list-inline-item h6 me-3 mb-1 mb-sm-0">
									<i class="fas fa-user-graduate text-orange me-2"></i>12k Enrolled
								</li>
								<li class="list-inline-item h6 me-3 mb-1 mb-sm-0">
									<i class="fas fa-signal text-success me-2"></i>All levels
								</li>
								<li class="list-inline-item h6 me-3 mb-1 mb-sm-0">
								...
								<li class="list-inline-item h6 mb-0">
									<i class="fas fa-globe text-info me-2"></i>English
								</li>
							</ul>
						</div>
					</div>
				...
				<div class="container">
					<div class="row">
						...
						<div class="bg-body shadow rounded-2 p-4">
								<ul class="nav nav-pills nav-tabs-line pt-0"
								...
								>
									<li class="nav-item me-2 me-sm-4" role="presentation">
										<button class="nav-link mb-2 mb-md-0 active" 
												...
												data-bs-target="#course-pills-1" type="button" 
									...
									<li class="nav-item me-2 me-sm-4" role="presentation">
										<button class="nav-link mb-2 mb-md-0" id="course-pills-tab-5"
												data-bs-toggle="pill" data-bs-target="#course-pills-5"
												type="button" role="tab" aria-controls="course-pills-5" 
												aria-selected="false">FAQs
										</button>
									</li>
								</ul>
								<hr/>
								...
								<div class="tab-content pt-2" id="course-pills-tabContent">
									...
									>
										...
										<p class="mb-3">Welcome to the <strong> 
											Digital Marketing Ultimate Course Bundle - 12 Courses in 1 
											(Over 36 hours of content)</strong>
										</p>
										<p class="mb-3">In this practical hands-on training, 
											you’re going to learn to become a digital marketing expert with 
											this <strong> ultimate course bundle that includes 12 digital 
											marketing courses in 1!</strong>
										</p>
										<p class="mb-3">If you wish to find out the skills that should be 
										...
										<p class="mb-0">We focus a great deal on the understanding of behavioral 
											...
											done so that’s why this course is packed with practical hands-on examples that 
											...
											<div class="accordion-item mb-3">
												<h6 class="accordion-header font-base" id="heading-1">
													<button class="accordion-button fw-bold rounded d-sm-flex d-inline-block collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapse-1" aria-expanded="true" aria-controls="collapse-1">
														...
														<span class="small ms-0 ms-sm-2">(2 Lectures)</span> 
													</button>
												</h6>
									...
									<div class="tab-pane fade" id="course-pills-3" role="tabpanel" 
										...
										<p class="mb-3">Fulfilled direction use continual set him propriety 
											continued. Saw met applauded favorite deficient engrossed 
											concealed and her. Concluded boy perpetual old supposing. Farther 
											related bed and passage comfort civilly. Dashboards see frankness 
											ojection abilities. As hastened oh produced prospect formerly up 
											am. Placing forming nay looking old married few has. Margaret 
											disposed of add screened rendered six say his striking confined. 
										</p>
										<p class="mb-3">As it so contrasted oh estimating instrument. Size 
											like body someone had. Are conduct viewing boy minutes warrant 
									...
									<div class="tab-pane fade" id="course-pills-4" 
												...
												<div class="row align-items-center">
													<div class="col-6 col-sm-8">
														<div class="progress progress-sm bg-warning bg-opacity-15">
															<div class="progress-bar bg-warning persen100" 
													...
													<div class="col-6 col-sm-8">
														<div class="progress progress-sm bg-warning bg-opacity-15">
															<div class="progress-bar bg-warning persen80" 
																role="progressbar"></div>
														</div>
													</div>
													...
													<div class="col-6 col-sm-8">
														<div class="progress progress-sm bg-warning bg-opacity-15">
															<div class="progress-bar bg-warning persen60" 
																 role="progressbar">
													...
													<div class="col-6 col-sm-8">
														<div class="progress progress-sm bg-warning bg-opacity-15">
															<div class="progress-bar bg-warning persen40" 
																role="progressbar">
															</div>
														</div>
													</div>
													...
													<div class="col-6 col-sm-8">
														<div class="progress progress-sm bg-warning bg-opacity-15">
															<div class="progress-bar bg-warning persen20" 
																role="progressbar">
															</div>
														</div>
													</div>
												...
												<div>
													...
													<div class="btn-group" role="group" 
														...
														<label class="btn btn-outline-light btn-sm mb-0" 
															for="btnradio1">
															<i class="far fa-thumbs-up me-1"></i>25
														</label>
											...
											<div class="d-md-flex mb-4 ps-4 ps-md-5">
												...
												<div>
													...
													<p class="mb-2">Water timed folly right aware if oh truth. 
														Imprudence attachment him for sympathize. Large above 
										...
										<ul class="list-group list-group-borderless">
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-book-open text-primary"></i>Lectures
												</span>
												<span>30</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-clock text-primary"></i>Duration
												</span>
												<span>4h 50m</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-signal text-primary"></i>Skills
												</span>
												<span>Beginner</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-globe text-primary"></i>Language
												</span>
												<span>English</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-user-clock text-primary"></i>Deadline
												</span>
												<span>Nov 30 2021</span>
											</li>
											<li class="list-group-item d-flex justify-content-between align-items-center">
												<span class="h6 fw-light mb-0">
													<i class="fas fa-fw fa-medal text-primary"></i>Certificate
												</span>
												<span>Yes</span>
											</li>
										</ul>
								...
								<div class="col-md-6 col-lg-12">
									...
									<div class="card card-body shadow p-4 mb-4">
										...
										<div class="row gx-3 mb-3">
											...
											<div class="col-4">
												<img class="rounded" src={avatar5} alt=""/>
											</div>
										...
										<div class="row gx-3">
											...
											<div class="col-4">
												<img class="rounded" src={avatar6} alt=""/>
											</div>
